...
public class SucursalController : ControllerBase
{
    ...
    {
        IQueryable<Sucursales> query = _context.Sucursales;
    ...
    // POST: api/sucursales
    [HttpPost]
    public async Task<ActionResult<Sucursales>> PostSucursal(Sucursales sucursal)
    {
    ...
    [HttpPut("{id}")]
    public async Task<IActionResult> PutSucursal(int id, Sucursales sucursal)
    {
